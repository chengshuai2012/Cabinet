...
public class DatePicker extends FrameLayout {
    ...
    private final TextView mDaySpinnerInput;

    private final TextView mMonthSpinnerInput;

    private final TextView mYearSpinnerInput;
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDaySpinnerInput = (TextView) mDaySpinner.findViewById(R.id.np__numberpicker_input);
        ...
        mMonthSpinnerInput = (TextView) mMonthSpinner.findViewById(R.id.np__numberpicker_input);

        // year
        mYearSpinner = (NumberPicker) findViewById(R.id.year);
        mYearSpinner.setOnLongPressUpdateInterval(100);
        mYearSpinner.setOnValueChangedListener(onChangeListener);
        mYearSpinnerInput = (TextView) mYearSpinner.findViewById(R.id.np__numberpicker_input);
